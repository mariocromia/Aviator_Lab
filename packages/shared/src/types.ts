...
export interface TerminalRuntime {
  terminalId: string;
  gameStrategyRuntime: { state: GameStrategyState; processedRounds: number; lastMultiplier: number | null; triggerRoundId: string | null; lastAnnotationRole?: RoundAnnotationRole | null };
