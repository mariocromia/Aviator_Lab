import { Bell, Bot, ChartNoAxesCombined, ChevronDown, CircleDollarSign, Clock3, Database, FileClock, FlaskConical, Gauge, History, Layers3, ListTree, Maximize2, Menu, Minus, MonitorCog, PanelLeftClose, PlaySquare, Settings, ShieldCheck, Sparkles, SquareTerminal, TrendingUp, Workflow, X } from 'lucide-react';
...
const nav = [
  ...
  ['Estratégias', '/strategies', FlaskConical], ['Planos de aposta', '/bet-plans', ListTree], ['Planos de horários','/schedule-plans',Clock3], ['Regras de controle','/control-rules',Workflow], ['Banca', '/bankroll', CircleDollarSign], ['Histórico','/history',History], ['Gales','/gales',TrendingUp],
