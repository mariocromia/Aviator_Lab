...
contextBridge.exposeInMainWorld('aviator', {
  ...
  saveTerminalPreset:(terminalId:string,name:string)=>ipcRenderer.invoke('terminal-preset:save',{terminalId,name}),
  listTerminalPresets:()=>ipcRenderer.invoke('terminal-preset:list'),
  restoreTerminalPreset:(id:string)=>ipcRenderer.invoke('terminal-preset:restore',id),
  deleteTerminalPreset:(id:string)=>ipcRenderer.invoke('terminal-preset:delete',id),
  ...
  getRoundArchiveStatus: () => ipcRenderer.invoke('archive:status'),
  configureRoundArchive: (mode: 'PUBLISHER' | 'SUBSCRIBER') => ipcRenderer.invoke('archive:configure', { mode }),
  publishRoundArchive: () => ipcRenderer.invoke('archive:publish'),
  importRoundArchive: () => ipcRenderer.invoke('archive:import'),
  setBackgroundCollectorEnabled: (enabled: boolean) => ipcRenderer.invoke('archive:background', { enabled }),
  ...
  getTerminalHistoryDisplayMax:()=>ipcRenderer.invoke('display:terminal-history-max:get'),
  setTerminalHistoryDisplayMax:(value:number)=>ipcRenderer.invoke('display:terminal-history-max:set',value),
